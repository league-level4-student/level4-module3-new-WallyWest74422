...
public class MorseDecoder {
	 ...
	 */
	void decode() {
String morseCode =JOptionPane.showInputDialog("Please enter a line of Morse Code letters, each separated by a space.");
...
//		String[] letters = morseCode.split(" ");
	...
	String findLetter(String s, Node<MorseCode> mc) {
		...
		if (s.charAt(0) == '.') {
			return findLetter(s.substring(1), mc.getLeft());
		}
		return findLetter(s.substring(1), mc.getRight());
	}
}
